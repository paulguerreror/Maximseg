...
import kotlinx.android.synthetic.main.activity_novedad.*
import kotlinx.android.synthetic.main.activity_novedad.contentView
import kotlinx.android.synthetic.main.activity_novedad.progressView
import kotlinx.android.synthetic.main.fragment_tareas_generales.*
import kotlinx.android.synthetic.main.novedades.*
...
class NovedadActivity : AppCompatActivity() {
    ...
    fun dispatchTakePictureIntent(view: View) {
        Dexter.withActivity(this@NovedadActivity)
            ...
            .withListener(object: PermissionListener {
                ...
                override fun onPermissionDenied(response: PermissionDeniedResponse?) {
                    Toast.makeText(this@NovedadActivity, R.string.error_permissions, Toast.LENGTH_SHORT).show()
                }
                override fun onPermissionRationaleShouldBeShown(permission: PermissionRequest?, token: PermissionToken?) {
                    token!!.continuePermissionRequest()
                }
            }).
                withErrorListener{ Toast.makeText(this@NovedadActivity, R.string.error_permissions, Toast.LENGTH_SHORT).show()}
            .onSameThread()
            .check()
    }
